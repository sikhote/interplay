...
import { notify } from 'lib/store/features/notifications';
import differenceInMinutes from 'date-fns/differenceInMinutes';
import serviceRequest from 'lib/service';
import * as filesActions from 'lib/store/features/files';

const storage = {};

const getInitialState = () => ({
  // initial starting disconnected connecting connected authing authed
  status: 'initial',
  service: 'dropbox',
  data: undefined,
  members: undefined,
